...
<html lang="en">
  <head>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            <li><a href="mycount.jsp"><i class="fa fa-user"></i> 我的账户</a></li>
                           <% 
	...
	<form action="${pageContext.request.contextPath }/BiddersHaveBeenSuccessfulDisplay" method="post">
