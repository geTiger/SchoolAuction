...
<html lang="en">
 ...
 <!-- 付款列表 -->
 	...
 	<form action="${pageContext.request.contextPath }/CheckOutDisplay" method="post">
	<table  class="table table-striped">
	<tr><td>
	<div>
		<label >用户名</label>
		<input id="updatePeople" name="updatePeople" readonly="true" value=${user.username} type="text"/>
	</div>
	</td>
	<td>
	<button type="submit" class="btn">显示</button>
	</td>
	</tr>
	</table>
	</form>
 ...
 <!--  <c:forEach var="good"   items="${goodsList}">
  ...
  <tr>
   	<form action="${pageContext.request.contextPath }/CheckMoney" method="post">
	<table  class="table table-striped">
	<tr><td>
	<div>
		<input id="updatePeople" name="updatePeople" type="hidden" value=${user.username} type="text"/>
	</div>
	</td>
	<td>
