            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="single-sidebar">
                        <h2 class="sidebar-title">查找物品</h2>
                        <form action="#">
                            <input type="text" placeholder="查找物品...">
                    ...
                    <div class="product-content-right">
                        <div class="woocommerce">
                            ...
                            <form method="post" action="#" class="shipping_calculator">
                                <h2><a class="shipping-calculator-button" data-toggle="collapse" href="#calcalute-shipping-wrap" aria-expanded="true" aria-controls="calcalute-shipping-wrap">Calculate Shipping</a></h2>
